    ...
    <View style={[styles.container, { backgroundColor: darkMode ? '#101010' : '#fff' }]}>
      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 120 }}>
        ...
        <View style={styles.descriptionContainer}>
          <Text style={[styles.description, { color: darkMode ? '#d0d0d0' : '#000000ff' }]}>
          ...
          <TouchableOpacity
            style={styles.deliveryProcessButton}
            activeOpacity={0.9}
            onPress={() => router.push('/(tabs)/delivery-process' as any)}
          >
            <Text style={styles.deliveryProcessButtonText}>DELIVERY & ORDERING PROCESS</Text>
          </TouchableOpacity>
        </View>
        ...
        {loading ? (
          <View style={styles.loadingContainer}>
            ...
            <Text style={[styles.loadingText, { color: darkMode ? '#b8b8b8' : '#666' }]}>Loading services...</Text>
          </View>
        ) : (
          <View style={styles.gridContainer}>
            {services.map((service) => (
              <TouchableOpacity
                key={service.id}
                style={[styles.card, { backgroundColor: darkMode ? '#1f1f1f' : '#2c2c2c' }]}
                activeOpacity={0.85}
                onPress={() =>
                  router.push({
              ...
              >
                ...
                <Text style={[styles.cardDescription, { color: darkMode ? '#c6c6c6' : '#bbb' }]}>

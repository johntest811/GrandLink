      ...
      <ScrollView style={[styles.container, { backgroundColor: darkMode ? "#101010" : "#fff" }]}>
        ...
        <View style={styles.header}>
          <MaterialCommunityIcons
            ...
            color="#fff"
          />
          <Text style={styles.headerTitle}>Canopy</Text>
        </View>
        ...
        <View style={[styles.content, { backgroundColor: darkMode ? "#101010" : "#fff" }]}>
          ...
          Grand East provides durable and stylish canopies for patios, walkways, and entrances.
        Customizable in size and material, our canopies are designed to complement your property
         while withstanding harsh weather.{"\n\n"}
          </Text>
        </View>

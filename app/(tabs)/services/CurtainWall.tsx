      ...
      <ScrollView style={[styles.container, { backgroundColor: darkMode ? "#101010" : "#fff" }]}>
        ...
        <View style={styles.header}>
          <MaterialCommunityIcons
            ...
            color="#fff"
          />
          <Text style={styles.headerTitle}>Curtain Wall</Text>
        </View>

        {/* Main Content */}
        <View style={[styles.content, { backgroundColor: darkMode ? "#101010" : "#fff" }]}>
          <Text style={[styles.subHeading, { color: darkMode ? "#e07a7a" : "#b71c1c" }]}>
            Curtain Walls:{"\n"}Modern Elegance and Maximum Light
          </Text>
          <Text style={[styles.description, { color: darkMode ? "#d0d0d0" : "#333" }]}>
          Grand East&apos;s high-performance curtain walls provide sleek,
        unobstructed views with large glass panels supported by a durable frame.
        Ideal for commercial and residential properties, these systems offer natural light,

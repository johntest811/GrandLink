      ...
      <ScrollView style={[styles.container, { backgroundColor: darkMode ? "#101010" : "#fff" }]}>
        ...
        <View style={styles.header}>
          <MaterialCommunityIcons
            ...
            color="#fff"
          />
          <Text style={styles.headerTitle}>Customized Design</Text>
        </View>
        ...
        <View style={[styles.content, { backgroundColor: darkMode ? "#101010" : "#fff" }]}>
          ...
          At Grand East, we turn your vision into reality with personalized design and expert craftsmanship.
           From intricate details to bold statements, our custom solutions exceed expectations

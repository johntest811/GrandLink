      ...
      <ScrollView style={[styles.container, { backgroundColor: darkMode ? "#101010" : "#fff" }]}>
        ...
        <View style={styles.header}>
          <MaterialCommunityIcons
            ...
            color="#fff"
          />
          <Text style={styles.headerTitle}>Facade</Text>
        </View>
        ...
        <View style={[styles.content, { backgroundColor: darkMode ? "#101010" : "#fff" }]}>
          ...
          <Text style={[styles.description, { color: darkMode ? "#d0d0d0" : "#333" }]}>
            Grand East&apos;s facade solutions, including curtain walls and custom designs,
            enhance your building&apos;s exterior with style and functionality.
            Reflect your brand while improving energy efficiency and durability.{"\n\n"}
          </Text>
        </View>

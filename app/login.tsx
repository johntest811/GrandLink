  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      if (!result.success) {
        ...
        // Include patterns for both HTTP 404 errors and various backend error messages
        ...
        if (isEmailInvalidError) {
          ...
          Alert.alert(
            'Email Not Found',
            'This email address is not registered with our system. Please check that you entered the correct email or create a new account.',
            [{ text: 'OK' }]
          );
          ...
          if (failureResult.shouldLockout) {
            ...
            const errorDetail = result.error?.includes('password') || result.error?.toLowerCase().includes('password') 
              ? 'Incorrect password' 
              : result.error;
            Alert.alert(
              'Login Failed',
      ...
      >
        <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
          <ThemedView style={styles.container}>
            ...
            {/* Login Card */}
            <View style={[styles.card, { backgroundColor: darkMode ? '#1a1a1a' : 'rgba(255, 255, 255, 0.95)' }]}>
              {/* Logo at the top */}
              <View style={styles.logoContainer}>
                ...
                <ThemedText style={[styles.logoSubtext, { color: darkMode ? '#b8b8b8' : '#050505ff' }]}>GLASS AND ALUMINIUM</ThemedText>
              </View>
              <ThemedText type="title" style={styles.loginTitle}>Login</ThemedText>

              {/* Email Input */}
              <View style={styles.inputContainer}>
                <ThemedText style={[styles.inputLabel, { color: darkMode ? '#e6e6e6' : '#080808ff' }]}>Email</ThemedText>
                <View style={[styles.inputWrapper, { borderColor: darkMode ? '#3a3a3a' : '#323232ff', backgroundColor: darkMode ? '#242424' : 'transparent' }]}>
                  <TextInput
                    style={[styles.input, { color: darkMode ? '#f2f2f2' : '#000000' }]}
                    placeholder="Please Enter your Email Address"
                    placeholderTextColor={darkMode ? '#9a9a9a' : '#696969ff'}
                    value={email}
              ...
              {/* Password Input */}
              <View style={styles.inputContainer}>
                <ThemedText style={[styles.inputLabel, { color: darkMode ? '#e6e6e6' : '#080808ff' }]}>Password</ThemedText>
                <View style={[styles.inputWrapper, { borderColor: darkMode ? '#3a3a3a' : '#323232ff', backgroundColor: darkMode ? '#242424' : 'transparent' }]}>
                  <TextInput
                    style={[styles.input, { color: darkMode ? '#f2f2f2' : '#000000' }]}
                    ...
                    <ThemedText style={styles.lockdownText}>
                      Account locked - Try again in {lockdownTimer}m
                                ...
                                <TouchableOpacity style={styles.forgotPasswordContainer} onPress={() => router.push('/forgot-password')}>
                                  <ThemedText style={[styles.forgotPassword, { color: darkMode ? '#e0e0e0' : '#000000ff' }]}>Forgot Password</ThemedText>
                </TouchableOpacity>
              </View>
              ...
              <View style={styles.signupContainer}>
                <ThemedText style={[styles.signupText, { color: darkMode ? '#c8c8c8' : '#666' }]}>Don’t have an account yet?</ThemedText>
                <Link href="/register">
                  <ThemedText style={[styles.signupLink, { color: darkMode ? '#7fb3ff' : '#2563eb' }]}>Sign Up</ThemedText>
                </Link>
              </View>
            </View>
          </ThemedView>

    ...
    try {
      ...
      if (!result.success) {
        ...
        const shouldResetCode =
          message.toLowerCase().includes('new 6-digit code was sent') ||
          message.toLowerCase().includes('no active verification code');
          ...
          <View style={styles.container}>
            <View style={[styles.card, { backgroundColor: darkMode ? '#1a1a1a' : 'rgba(255, 255, 255, 0.95)' }]}>
              ...
              <View style={styles.logoContainer}>
                ...
                <Text style={[styles.logoSubtext, { color: darkMode ? '#b8b8b8' : '#050505ff' }]}>GLASS AND ALUMINIUM</Text>
              </View>

              <Text style={styles.title}>Enter Verification Code</Text>
              
              <Text style={[styles.subtitle, { color: darkMode ? '#d0d0d0' : '#333' }]}>
                We sent a 6-digit code to
              </Text>
              <Text style={styles.email}>{email}</Text>
              
              {isOAuth && (
                <Text style={[styles.oauthNote, { color: darkMode ? '#b8b8b8' : '#666' }]}>
              ...
              <View style={styles.codeContainer}>
                {code.map((digit, index) => (
                  <TextInput
                    ...
                    style={[
                      styles.codeInput,
                      { backgroundColor: darkMode ? '#242424' : 'white', color: darkMode ? '#f2f2f2' : '#111', borderColor: darkMode ? '#3a3a3a' : '#d1d5db' },
              ...
              <View style={styles.resendContainer}>
                <Text style={[styles.resendText, { color: darkMode ? '#d0d0d0' : '#333' }]}>Didn&apos;t receive the code?</Text>
                <TouchableOpacity
              ...
              >
                <Text style={[styles.backButtonText, { color: darkMode ? '#d0d0d0' : '#333' }]}>← Back to Login</Text>
              </TouchableOpacity>

              {/* Security note */}
              <Text style={[styles.securityText, { color: darkMode ? '#b8b8b8' : '#666' }]}>

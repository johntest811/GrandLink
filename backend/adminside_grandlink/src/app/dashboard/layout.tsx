...
export default function DashboardLayout({
  ...
  const navStructure = [
    ...
    // User Inquiries is now outside Content Management
    { name: 'User Inquiries', path: '/dashboard/inquiries', icon: '📨' },
    {
      ...
      dropdown: [
        ...
        // { name: 'Products', path: '/dashboard/pages/products' },
        { name: 'FAQs', path: '/dashboard/pages/FAQs' },
        { name: 'Inquire Page Editor', path: '/dashboard/inquiries/editor', icon: '📝' }, // Editor stays in Content Management
      ],
    },

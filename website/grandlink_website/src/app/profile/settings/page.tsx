  ...
  return (
    <div className="bg-white rounded-xl shadow-lg w-full max-w-xl p-8 mx-auto mt-12">
      ...
      <form className="flex flex-col gap-4">
        ...
        <input type="password" placeholder="New Password" className="border rounded px-3 py-2 text-gray-400" />
        <input type="password" placeholder="Confirm New Password" className="border rounded px-3 py-2 text-gray-400" />

      ...
      <main className="flex-1">
        <section className="py-12 px-4 max-w-4xl mx-auto">
          <div className="bg-white shadow-lg rounded-xl p-8">
            <h2 className="text-2xl font-bold text-center mb-2 text-black">Reservation Form</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-4 text-black">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex gap-2">
                  <span className="border rounded-lg p-3 bg-gray-100 text-black">+63</span>
                  <input
                    type="tel"
                    name="phone"
              ...
              {/* Construction */}
              <div>
                <p className="font-semibold mb-2 text-black">Construction (Optional)</p>
                <div className="flex gap-4">
                  <label className="flex items-center gap-2 text-black">
                    <input
                      ...
                      name="construction"
                      value="new"
                      checked={formData.construction === "new"}
                      onChange={handleChange}
                    /> New
                  </label>
                  <label className="flex items-center gap-2 text-black">
                    <input
                      ...
                      name="construction"
                      value="renovation"
                      checked={formData.construction === "renovation"}
                      onChange={handleChange}
                    /> Renovation
                  </label>
                </div>

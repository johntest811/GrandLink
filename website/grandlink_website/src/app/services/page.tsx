...
function ServiceCard({
  ...
  return (
    <div className="perspective" onClick={onClick}>
      ...
      >
        {/* Front */}
        <div className="absolute inset-0 flex flex-col items-center justify-center bg-[#232d3b] text-white rounded shadow-lg backface-hidden">
          {icon}
          <span className="mt-2 font-semibold">{label}</span>
        </div>
        {/* Back */}
        <div className="absolute inset-0 flex flex-col items-center justify-center bg-white text-[#232d3b] rounded shadow-lg backface-hidden" 
